Final blocker check for Bowerbird PR #816. Review only this diff, especially configured date parsing, canonical ISO including years 0001-0099, strict format precedence, scalar/list parity, deterministic config->$TODAY->new->audit coverage, and docs.

First line exactly BLOCKERS, NON-BLOCKING, or NO BLOCKERS. Under 100 words. No tools or mutations.
...
+          },
         ...
         types: {
           note: {
@@ -432,6 +437,47 @@ describe('validation', () => {
